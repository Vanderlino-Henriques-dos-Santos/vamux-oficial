// === cadastro-passageiro.js ===
// Cadastro de Passageiro com Firebase Auth e Realtime Database
...
// === [1] Configuração do Firebase com .env via Vite ===
...
form.addEventListener("submit", async (e) => {
  ...
  try {
    ...
    mostrarMensagem("Passageiro cadastrado com sucesso!", "sucesso");
